# CapCut 드래프트 스키마 (draft_info.json)

> **주의**: CapCut은 공식 스펙을 공개하지 않는다. 이 문서는 CapCut 4.x 데스크톱 드래프트 폴더를 역공학한 내용으로, 차기 세션에서 Claude Code 코웍으로 **실제 드래프트를 열어보며 교정**할 기초 스케치이다.
